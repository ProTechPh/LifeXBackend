...
def get_client_ip(request):
    ...
    SECURITY NOTE: HTTP_X_FORWARDED_FOR can be spoofed by attackers.
    Only trust it if you're behind a known proxy/load balancer.
    ...
    # Check if we should trust X-Forwarded-For header
    # This should only be True if behind a trusted proxy (nginx, AWS ELB, etc.)
    use_x_forwarded_for = getattr(settings, 'USE_X_FORWARDED_HOST', False)
